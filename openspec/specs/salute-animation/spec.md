...
The salute animation provides a canvas-based confetti/fireworks celebration effect that renders behind the congratulation modal. It creates visual excitement using particles in the application color palette.
