...
See [DEVELOPMENT.md](./docs/DEVELOPMENT.md) for comprehensive development guidelines including:

- Project setup and available scripts
- Component architecture and state management patterns
- Tailwind CSS styling with our custom color palette
- Code quality checklist and pre-commit requirements
- Testing with Vitest
