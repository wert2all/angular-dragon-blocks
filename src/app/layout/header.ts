...
@Component({
  ...
  template: `
    <header class="px-6 mt-6 flex items-center gap-4 ml-16">
      <a
      ...
      >
        <img
          ...
          height="48"
          priority
          class="h-72 sm:h-36 w-auto object-contain"
        />
        <div class="hidden h-12 sm:h-16 w-px bg-vibrant-orange/40 sm:block"></div>
        <span
          class="hidden text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight text-deep-purple sm:block font-fancy"
        >
          <b class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl">Dragon Blocks:</b>
          <span class="hidden md:inline ml-4 mr-8">Reading Adventures</span>
        </span>
      </a>
      <a
        role="button"
